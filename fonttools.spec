...
Source0  : https://github.com/fonttools/fonttools/archive/4.9.0/fonttools-4.9.0.tar.gz
...
%prep
%setup -q -n fonttools-4.9.0
cd %{_builddir}/fonttools-4.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589240051
...
cp %{_builddir}/fonttools-4.9.0/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
cp %{_builddir}/fonttools-4.9.0/LICENSE.external %{buildroot}/usr/share/package-licenses/fonttools/46257398789046604c89898b8cf62340405bdb94
...
/usr/share/package-licenses/fonttools/46257398789046604c89898b8cf62340405bdb94
