...
Source0  : https://github.com/fonttools/fonttools/archive/4.47.2/fonttools-4.47.2.tar.gz
...
%prep
%setup -q -n fonttools-4.47.2
cd %{_builddir}/fonttools-4.47.2
pushd ..
cp -a fonttools-4.47.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704984820
