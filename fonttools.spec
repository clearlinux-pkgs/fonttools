...
Version  : 4.19.0
Release  : 66
URL      : https://github.com/fonttools/fonttools/archive/4.19.0/fonttools-4.19.0.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.19.0/fonttools-4.19.0.tar.gz
...
%prep
%setup -q -n fonttools-4.19.0
cd %{_builddir}/fonttools-4.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611613449
...
cp %{_builddir}/fonttools-4.19.0/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
cp %{_builddir}/fonttools-4.19.0/LICENSE.external %{buildroot}/usr/share/package-licenses/fonttools/f8a58cf6a89043d2ad651473e3ea767ce13cd34e
