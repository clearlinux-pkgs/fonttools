...
Version  : 4.26.1
Release  : 84
URL      : https://github.com/fonttools/fonttools/archive/4.26.1/fonttools-4.26.1.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.26.1/fonttools-4.26.1.tar.gz
...
%prep
%setup -q -n fonttools-4.26.1
cd %{_builddir}/fonttools-4.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628000944
...
cp %{_builddir}/fonttools-4.26.1/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
cp %{_builddir}/fonttools-4.26.1/LICENSE.external %{buildroot}/usr/share/package-licenses/fonttools/f8a58cf6a89043d2ad651473e3ea767ce13cd34e
