...
Version  : 4.52.4
Release  : 140
URL      : https://github.com/fonttools/fonttools/archive/4.52.4/fonttools-4.52.4.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.52.4/fonttools-4.52.4.tar.gz
...
%prep
%setup -q -n fonttools-4.52.4
cd %{_builddir}/fonttools-4.52.4
pushd ..
cp -a fonttools-4.52.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716860349
