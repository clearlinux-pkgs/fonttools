...
Version  : 4.26.2
Release  : 85
URL      : https://github.com/fonttools/fonttools/archive/4.26.2/fonttools-4.26.2.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.26.2/fonttools-4.26.2.tar.gz
...
%prep
%setup -q -n fonttools-4.26.2
cd %{_builddir}/fonttools-4.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628528449
...
cp %{_builddir}/fonttools-4.26.2/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
