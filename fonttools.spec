...
Version  : 4.55.6
Release  : 149
URL      : https://github.com/fonttools/fonttools/archive/4.55.6/fonttools-4.55.6.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.55.6/fonttools-4.55.6.tar.gz
...
%prep
%setup -q -n fonttools-4.55.6
cd %{_builddir}/fonttools-4.55.6
%patch -P 1 -p1
pushd ..
cp -a fonttools-4.55.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738016357
