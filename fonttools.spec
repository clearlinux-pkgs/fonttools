...
Source0  : https://github.com/fonttools/fonttools/archive/4.10.0/fonttools-4.10.0.tar.gz
...
%prep
%setup -q -n fonttools-4.10.0
cd %{_builddir}/fonttools-4.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589907965
...
cp %{_builddir}/fonttools-4.10.0/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
