...
Source0  : https://github.com/fonttools/fonttools/archive/4.4.2/fonttools-4.4.2.tar.gz
...
%prep
%setup -q -n fonttools-4.4.2
cd %{_builddir}/fonttools-4.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584059124
...
cp %{_builddir}/fonttools-4.4.2/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
cp %{_builddir}/fonttools-4.4.2/LICENSE.external %{buildroot}/usr/share/package-licenses/fonttools/9e8dedfa954e04fa103507441dcd4010c90ddedd
