...
Version  : 4.44.1
Release  : 126
URL      : https://github.com/fonttools/fonttools/archive/4.44.1/fonttools-4.44.1.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.44.1/fonttools-4.44.1.tar.gz
...
%prep
%setup -q -n fonttools-4.44.1
cd %{_builddir}/fonttools-4.44.1
pushd ..
cp -a fonttools-4.44.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699976810
