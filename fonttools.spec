...
Version  : 4.28.4
Release  : 96
URL      : https://github.com/fonttools/fonttools/archive/4.28.4/fonttools-4.28.4.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.28.4/fonttools-4.28.4.tar.gz
...
%prep
%setup -q -n fonttools-4.28.4
cd %{_builddir}/fonttools-4.28.4
pushd ..
cp -a fonttools-4.28.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639676914
...
cp %{_builddir}/fonttools-4.28.4/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
