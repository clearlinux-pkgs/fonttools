...
Version  : 4.10.2
Release  : 48
URL      : https://github.com/fonttools/fonttools/archive/4.10.2/fonttools-4.10.2.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.10.2/fonttools-4.10.2.tar.gz
...
%prep
%setup -q -n fonttools-4.10.2
cd %{_builddir}/fonttools-4.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589985141
...
cp %{_builddir}/fonttools-4.10.2/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
