...
Version  : 4.53.1
Release  : 142
URL      : https://github.com/fonttools/fonttools/archive/4.53.1/fonttools-4.53.1.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.53.1/fonttools-4.53.1.tar.gz
...
%prep
%setup -q -n fonttools-4.53.1
cd %{_builddir}/fonttools-4.53.1
pushd ..
cp -a fonttools-4.53.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720464474
