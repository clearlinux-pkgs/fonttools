...
Version  : 4.2.1
Release  : 33
URL      : https://github.com/fonttools/fonttools/archive/4.2.1/fonttools-4.2.1.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.2.1/fonttools-4.2.1.tar.gz
...
%prep
%setup -q -n fonttools-4.2.1
cd %{_builddir}/fonttools-4.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575786126
...
cp %{_builddir}/fonttools-4.2.1/LICENSE %{buildroot}/usr/share/package-licenses/fonttools/3b4f969a237019242665f7adacc882c35a82c145
cp %{_builddir}/fonttools-4.2.1/LICENSE.external %{buildroot}/usr/share/package-licenses/fonttools/9e8dedfa954e04fa103507441dcd4010c90ddedd
