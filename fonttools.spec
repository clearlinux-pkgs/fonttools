...
Source0  : https://github.com/fonttools/fonttools/archive/4.37.3/fonttools-4.37.3.tar.gz
...
%prep
%setup -q -n fonttools-4.37.3
cd %{_builddir}/fonttools-4.37.3
pushd ..
cp -a fonttools-4.37.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663682492
