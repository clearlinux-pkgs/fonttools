...
Source0  : https://github.com/fonttools/fonttools/archive/4.58.0/fonttools-4.58.0.tar.gz
...
%prep
%setup -q -n fonttools-4.58.0
cd %{_builddir}/fonttools-4.58.0
%patch -P 1 -p1
pushd ..
cp -a fonttools-4.58.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747065783
