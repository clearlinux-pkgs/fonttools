...
Version  : 4.57.0
Release  : 153
URL      : https://github.com/fonttools/fonttools/archive/4.57.0/fonttools-4.57.0.tar.gz
Source0  : https://github.com/fonttools/fonttools/archive/4.57.0/fonttools-4.57.0.tar.gz
...
%prep
%setup -q -n fonttools-4.57.0
cd %{_builddir}/fonttools-4.57.0
%patch -P 1 -p1
pushd ..
cp -a fonttools-4.57.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743688790
